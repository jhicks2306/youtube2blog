...
export function EditVideoIconButton({ id }: { id: string }) {
  return (
    <Link href={`/${id}/edit-blog`} className="group flex h-9 w-9 shrink-0 items-center justify-center gap-2 rounded-full bg-muted text-lg font-semibold text-muted-foreground md:h-8 md:w-8 md:text-base">
